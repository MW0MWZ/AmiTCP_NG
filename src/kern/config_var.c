...
STRPTR KW_VARS = (STRPTR)
  ...
  "ULO=USELOOPBACK,SDMA=SANADMA,NETPRI=NETTASKPRI,"
  "TCPSND=TCP_SENDSPACE,TCPRCV=TCP_RECVSPACE,TCPMSS=TCP_MSSDFLT,"
...
extern LONG ng_task_pri ;	 int ng_task_pri_changed(void *pt, LONG new);
...
{ VAR_LONG, VF_RW, NULL, &ng_task_pri, ng_task_pri_changed },
...
{ VAR_ENUM, VF_RCONF, NULL, &ng_mbufcheck, boolean_enum }
};
